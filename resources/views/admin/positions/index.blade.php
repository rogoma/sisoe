            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('positions.index') }}">Cargos</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <a href="{{ route('positions.create') }}" class="btn btn-primary">Agregar Cargo</a>  
                                    </div>
                                </div>
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <table id="positions" class="table table-striped table-bordered nowrap">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Cargo</th>
                                            ...
                                            @for ($i = 0; $i < count($positions); $i++)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" title="Editar" class="btn btn-warning btn-icon" onclick="updatePosition({{ $positions[$i]->id }})">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                        <button type="button" title="Borrar" class="btn btn-danger btn-icon" onclick="deletePosition({{ $positions[$i]->id }})">
...
$(document).ready(function(){
    ...
    updatePosition = function(position){
        location.href = '/positions/'+position+'/edit/';
    }
