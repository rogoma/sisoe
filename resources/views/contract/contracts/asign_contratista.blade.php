            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Asignar Acceso a Contratista a Contrato N° {{$contract->number_year }}</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <br> --}}
                                    <form class="row" method="POST" action="{{ route('contracts.update.contra', $contract->id) }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-sm-12">
                                            <br><br><br>
                                            <h3 class="text-center">Asignar Usuario Contratista al Sistema</h3>
                                        </div>

                                        <div class="col-sm-3">
                                            <div class="form-group @error('contra_user_id') has-danger @enderror">
                                                <label class="col-form-label">Usuario<br></small></label>
                                                <select id="contra_user_id" name="contra_user_id" class="form-control">
                                                    <option value="">Seleccionar Usuario Contratista</option>
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}" @if ($user->id == old('contra_user_id', $contract->contra_user_id)) selected @endif>{{ $user->name }} {{ $user->lastname }} - {{ $user->position->description }}</option>
                                                @endforeach
                                                </select>
                                                @error('contra_user_id')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-danger m-b-0 f-12">Asignar Usuario Contratista</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
