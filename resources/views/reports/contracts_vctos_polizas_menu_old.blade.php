...
@else
    <h2 style="color:#ff0000">MENU DE ALERTA DE DETALLES DE PÓLIZAS</h2>
        <table>
            <tr>
                <th>#</th>
                <th>ID</th>
            ...
            <tr>
                ...
                <td> <button type="button" title="Editar" class="btn btn-warning btn-icon" onclick="updateItem({{ $contracts_poli[$i]->dependency_id }})">
...
{{-- @else
        <br>
        <h2 style="color:#ff0000">MENU DE ALERTA DE DETALLES DE ENDOSOS</h2>
        <table>
            <tr>
                <th>#</th>
                <th>Dependencia</th>
