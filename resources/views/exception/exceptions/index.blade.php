            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <a href="pdf/panel_exception" class="btn btn-danger" target="_blank">PANEL DE LLAMADOS</a>
                                            ...
                                            @for ($i = 0; $i < count($orders); $i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $orders[$i]->queriesDeadline() }}</td>
                                                        @if (in_array($orders[$i]->orderState->id, [20,55,62,97,101,125,130]))
                                                    ...
                                                    <td>                                                        
                                                        @if ($orders[$i]->actual_state == 20)
                                                            <a href="{{ route('exceptions.show', $orders[$i]->id) }}" class="btn btn-success">Recibir Llamado</a>
                                                        @else
                                                            @if ($orders[$i]->actual_state == 130)
                                                                <a href="{{ route('exceptions.show', $orders[$i]->id) }}" class="btn btn-danger">Procesar</a>
                                                            @else                                                                    
                                                                <a href="{{ route('exceptions.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>
                                                            @endif
                                                        @endif
                                                    </td>
                                                </tr>
