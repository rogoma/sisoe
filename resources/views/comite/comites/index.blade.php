            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('comites.index') }}">Llamados</a>
                        </li>
                    </ul>
                </div>
            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $orders[$i]->dncpPacIdFormat() }}</td>
                                                        ...
                                                        @else
                                                            ...
                                                            @endif
                                                        @endif                                                          
                                                        @if (in_array($orders[$i]->orderState->id, [35,69,100,135,136,137]))                                                                                                                    
                                                    ...
                                                    <td>
                                                        @if ($orders[$i]->actual_state == 35)
                                                            <a href="{{ route('comites.show', $orders[$i]->id) }}" class="btn btn-danger">Procesar</a>
                                                        @else                                                             
                                                             <a href="{{ route('comites.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>                                                            
                                                        @endif
