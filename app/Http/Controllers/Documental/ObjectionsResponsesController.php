...
class ObjectionsResponsesController extends Controller
{
    ...
    {
        $this->middleware('checkPermission:comites.objections.create')->only(['create', 'store']); // Permiso para create 
        $this->middleware('checkPermission:comites.objections.update')->only(['edit', 'update']); // Permiso para update 
    }
    ...
    public function create(Request $request, $objection_id)
    {
        ...
        return view('comite.objections_responses.create', compact('objection'));
    }
    ...
    public function store(Request $request, $objection_id)
    {
        ...
        return redirect()->route('comites.show', $objection->order_id)->with('success', 'Respuesta a reparo agregada correctamente');
    }
    ...
    public function edit(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return view('comite.objections_responses.update', compact('objection', 'objection_response'));
    }
    ...
    public function update(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return redirect()->route('comites.show', $objection->order_id)->with('success', 'Respuesta a reparo modificada correctamente');
    }
    ...
    public function destroy(Request $request, $objection_id, $objection_response_id)
    {
        ...
        if(!$request->user()->hasPermission(['comites.objections.delete'])){
