            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('tenders.show', $query->order_id) }}">Pedido Nº {{ $query->order_id }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('tenders.queries_responses.update', [$query->id, $query_response->id]) }}">
                                    @csrf
                                    @method('PUT')
