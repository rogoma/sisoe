...
class ObjectionsResponsesController extends Controller
{
    ...
    {
        $this->middleware('checkPermission:minor_purchases.objections.create')->only(['create', 'store']); // Permiso para create 
        $this->middleware('checkPermission:minor_purchases.objections.update')->only(['edit', 'update']); // Permiso para update 
    }
    ...
    public function create(Request $request, $objection_id)
    {
        ...
        return view('minor_purchase.objections_responses.create', compact('objection'));
    }
    ...
    public function store(Request $request, $objection_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $objection->order_id)->with('success', 'Respuesta a reparo agregada correctamente');
    }
    ...
    public function edit(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return view('minor_purchase.objections_responses.update', compact('objection', 'objection_response'));
    }
    ...
    public function update(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $objection->order_id)->with('success', 'Respuesta a reparo modificada correctamente');
    }
    ...
    public function destroy(Request $request, $objection_id, $objection_response_id)
    {
        ...
        if(!$request->user()->hasPermission(['minor_purchases.objections.delete'])){
