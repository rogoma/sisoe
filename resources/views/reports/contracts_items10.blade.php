...
<body>
    ...
    <table>
        <tfoot>
            <tr>
                <td colspan="12" style="font-size: 12px; font-weight: bold; text-align: left; padding: 15px;">
                    OBSERVACIÓN: {{ $contracts1[0]->orders_comments }}
                    <span style="background-color: yellow; padding: 2px 4px;">
                        Se establece un PLAZO DE EJECUCIÓN DE {{ $contracts1[0]->orders_plazo }} días.
                    </span>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="text-align: center;">Fecha Emisión: {{ \Carbon\Carbon::parse($contracts1[0]->orders_date)->format('d/m/Y') }}</td>
                <td colspan="3" style="text-align: center;">Firma Fiscalización</td>
                <td colspan="3" style="text-align: center;">{{ $contracts1[0]->fiscal_name }} {{ $contracts1[0]->fiscal_lastname }}</td>
            </tr>
            <tr>
                ...
                <td colspan="3" style="text-align: center;">Firma Contratista</td>
                <td colspan="3" style="text-align: center;">Aclaración Firma Contratista</td>
            </tr>
        </tfoot>
    </table>
</body>
