                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Cargar Descripción y Archivo de Evaluación Técnica</h5>
                                </div>
                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('contracts.files.store_eval', $contract->id) }}" enctype="multipart/form-data">
                                    @csrf
