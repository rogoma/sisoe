                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <table id="files" class="table table-striped table-bordered nowrap">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Archivo</th>
                                            ...
                                            @for ($i = 0; $i < count($files); $i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $files[$i]->file_type_id }}</td>                                                    
                                                    <td>
                                                        <button type="button" title="Editar" class="btn btn-warning btn-icon" onclick="updateFile({{ $files[$i]->id }})">
                                                            <i class="fa fa-pencil"></i>
                                                        </button>
                                                        <button type="button" title="Borrar" class="btn btn-danger btn-icon" onclick="deleteFile({{ $files[$i]->id }})">
