                                    ...
                                    <form class="row" method="POST" action="{{ route('orders.store') }}">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('responsible') has-danger @enderror">
                                                ...
                                                <input type="text" id="responsible" name="responsible" value="{{ old('responsible') }}" class="form-control">
                                                @error('responsible')
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group @error('begin_date') has-danger @enderror">
                                                <input type="text" id="begin_date" name="begin_date" value="{{ old('begin_date') }}" class="form-control" autocomplete="off">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group @error('sub_program') has-danger @enderror">
                                                ...
                                                @foreach ($sub_programs as $sub_program)
                                                    <option value="{{ $sub_program->id }}" @if ($sub_program->id == old('sub_program')) selected @endif>{{ $sub_program->budgetStructure() }}</option>
                                                @endforeach
                                                </select>
                                                @error('sub_program')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group @error('funding_source') has-danger @enderror">
                                                ...
                                                @foreach ($funding_sources as $funding_source)
                                                    <option value="{{ $funding_source->id }}" @if ($funding_source->id == old('funding_source')) selected @endif>{{ $funding_source->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('covid') has-danger @enderror">
                                                ...
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index              }}" @if ($index              == old('covid'         )) selected @endif>{{ $value                }}</option>                                                    
                                                @endforeach
                                                </select>
                                                @error('covid')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('system_awarded_by') has-danger @enderror">
                                                ...
                                                @foreach ($system_awarded_by as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('system_awarded_by')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('ad_referendum') has-danger @enderror">
                                                ...
                                                <select id="ad_referendum" name="ad_referendum" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('ad_referendum')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                                @error('ad_referendum')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('plurianualidad') has-danger @enderror">                                                
                                                ...
                                                <select id="plurianualidad" name="plurianualidad" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('plurianualidad')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div id="multi_year_template" class="col-sm-12 d-none">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 col-offset-4">
                                                    <div class="form-group">
                                        ...
                                        @if (old('plurianualidad') == 1)
                                            <div id="multi_years" class="w-100 @error('multi_year') has-danger @enderror">
                                            @php
                                                $years = old('multi_year_year');
                                                $amounts = old('multi_year_amount');
                                            @endphp
                                        ...
                                        {{-- <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object') has-danger @enderror">
                                                <label class="col-form-label">Objeto de Gasto 1<br></label>
                                                <select id="expenditure_object" name="expenditure_object" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                                @error('expenditure_object')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object_id" name="expenditure_object_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object2_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object2_id" name="expenditure_object2_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object2_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object3_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object3_id" name="expenditure_object3_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object3_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object4_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object4_id" name="expenditure_object4_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object4_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object5_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object5_id" name="expenditure_object5_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object5_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group @error('expenditure_object6_id') has-danger @enderror">
                                                ...
                                                <select id="expenditure_object6_id" name="expenditure_object6_id" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach ($expenditure_objects as $expenditure_object)
                                                    <option value="{{ $expenditure_object->id }}" @if ($expenditure_object->id == old('expenditure_object6_id')) selected @endif>{{ $expenditure_object->code }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount1" name="amount1" value="{{ old('amount1') }}" class="form-control amount1 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount1')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount2" name="amount2" value="{{ old('amount2') }}" class="form-control amount2 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount2')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount3" name="amount3" value="{{ old('amount3') }}" class="form-control amount3 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount3')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount4" name="amount4" value="{{ old('amount4') }}" class="form-control amount4 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount4')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount6" name="amount5" value="{{ old('amount5') }}" class="form-control amount5 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount5')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" id="amount6" name="amount6" value="{{ old('amount6') }}" class="form-control amount6 autonumber" data-a-sep="." data-a-dec=",">                                           
                                            @error('amount6')
                                                <div class="col-form-label">{{ $message }}</div>
                                            @enderror                                               
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('fonacide') has-danger @enderror">
                                                ...
                                                <select id="fonacide" name="fonacide" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('fonacide')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                                @error('fonacide')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('catalogs_technical_annexes') has-danger @enderror">
                                                ...
                                                <select id="catalogs_technical_annexes" name="catalogs_technical_annexes" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('catalogs_technical_annexes')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('alternative_offers') has-danger @enderror">
                                                ...
                                                <select id="alternative_offers" name="alternative_offers" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('alternative_offers')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        {{-- <div class="col-sm-4">
                                            <div class="form-group @error('open_contract') has-danger @enderror">
                                                <label class="col-form-label">Se utilizará la modalidad de contrato abierto</label>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('period_time') has-danger @enderror">
                                                ...
                                                <input type="text" id="period_time" name="period_time" value="{{ old('period_time') }}" class="form-control">
                                                @error('period_time')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('manufacturer_authorization') has-danger @enderror">
                                                ...
                                                <select id="manufacturer_authorization" name="manufacturer_authorization" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('manufacturer_authorization')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('financial_advance_percentage_amount') has-danger @enderror">
                                                ...
                                                <select id="financial_advance_percentage_amount" name="financial_advance_percentage_amount" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('financial_advance_percentage_amount')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('technical_specifications') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="technical_specifications" name="technical_specifications" class="form-control">{{ old('technical_specifications') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('samples') has-danger @enderror">
                                                ...
                                                <select id="samples" name="samples" class="form-control">
                                                    <option value="">Seleccionar</option>
                                                @foreach (array(0 => 'NO', 1 => 'SI') as $index => $value)
                                                    <option value="{{ $index }}" @if ($index == old('samples')) selected @endif>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                                @error('samples')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('delivery_plan') has-danger @enderror">
                                                ...
                                                <input type="text" id="delivery_plan" name="delivery_plan" value="{{ old('delivery_plan') }}" class="form-control">
                                                @error('delivery_plan')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('evaluation_committee_proposal') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="evaluation_committee_proposal" name="evaluation_committee_proposal" class="form-control">{{ old('evaluation_committee_proposal') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('payment_conditions') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="payment_conditions" name="payment_conditions" class="form-control">{{ old('payment_conditions') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('contract_guarantee') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="contract_guarantee" name="contract_guarantee" class="form-control">{{ old('contract_guarantee') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('product_guarantee') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="product_guarantee" name="product_guarantee" class="form-control">{{ old('product_guarantee') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('contract_administrator') has-danger @enderror">
                                                ...
                                                <input type="text" id="contract_administrator" name="contract_administrator" class="form-control" value="{{ old('contract_administrator') }}">
                                                </select>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('contract_validity') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="contract_validity" name="contract_validity" class="form-control">{{ old('contract_validity') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('additional_technical_documents') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="additional_technical_documents" name="additional_technical_documents" class="form-control">{{ old('additional_technical_documents') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('additional_qualified_documents') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="additional_qualified_documents" name="additional_qualified_documents" class="form-control">{{ old('additional_qualified_documents') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('price_sheet') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="price_sheet" name="price_sheet" class="form-control">{{ old('price_sheet') }}</textarea>
                                                @error('price_sheet')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('property_title') has-danger @enderror">
                                                ...
                                                <textarea rows="2" id="property_title" name="property_title" class="form-control">{{ old('property_title') }}</textarea>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('magnetic_medium') has-danger @enderror">
                                                ...
                                                <input type="text" id="magnetic_medium" name="magnetic_medium" value="{{ old('magnetic_medium') }}" class="form-control">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('referring_person_data') has-danger @enderror">
                                                ...
                                                <input type="text" id="referring_person_data" name="referring_person_data" value="{{ old('referring_person_data') }}" class="form-control">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('form4_city') has-danger @enderror">
                                                ...
                                                <input type="text" id="form4_city" name="form4_city" class="form-control" value="{{ old('form4_city') }}">
                                                @error('form4_city')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group @error('form4_date') has-danger @enderror">
                                                <input type="text" id="form4_date" name="form4_date" value="{{ old('form4_date') }}" class="form-control" autocomplete="off">
                                                <span class="input-group-append" id="basic-addon">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group @error('dncp_resolution_number') has-danger @enderror">
                                                ...
                                                <input type="text" id="dncp_resolution_number" name="dncp_resolution_number" value="{{ old('dncp_resolution_number') }}" class="form-control">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group @error('dncp_resolution_date') has-danger @enderror">
                                                <input type="text" id="dncp_resolution_date" name="dncp_resolution_date" value="{{ old('dncp_resolution_date') }}" class="form-control" autocomplete="off">
                                                <span class="input-group-append" id="basic-addon">
