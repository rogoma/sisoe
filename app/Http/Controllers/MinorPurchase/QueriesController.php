...
class QueriesController extends Controller
{
    ...
    public function create(Request $request, $order_id)
    {
        ...
        return view('minor_purchase.queries.create', compact('order'));
    }
    ...
    public function store(Request $request, $order_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $order_id)->with('success', 'Consulta agregada correctamente');
    }
    ...
    public function edit(Request $request, $order_id, $query_id)
    {
        ...
        return view('minor_purchase.queries.update', compact('query'));
    }
    ...
    public function update(Request $request, $order_id, $query_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $order_id)->with('success', 'Consulta modificada correctamente');
    }
