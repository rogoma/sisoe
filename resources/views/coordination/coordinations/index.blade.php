        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Pedidos/Llamados</h5>
                        {{-- <span>Listado de Pedidos y Llamados de Licitaciones</span> --}}
            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('coordinations.index') }}">Pedidos/Llamados</a>
                        </li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <table id="orders" class="table table-striped table-bordered">
                                            ...
                                            @for ($i = 0; $i < count($orders); $i++)
                                                <tr>
                                                    ...
                                                    {{-- <td>Llamado N° {{ $orders[$i]->number }} - {{ $orders[$i]->description }}</td> --}}
                                                    ...
                                                    <td>{{ $orders[$i]->dncpPacIdFormat() }}</td>
                                                        ...
                                                        @else
                                                            ...
                                                            @endif
                                                        @endif                                                       
                                                        @if (in_array($orders[$i]->orderState->id, [5,110,117,125,150,160]))
                                                            <td style="color:#ff0000">{{ $orders[$i]->orderState->id."-".$orders[$i]->orderState->description }}</td>
                                                        @else
                                                            @if (in_array($orders[$i]->orderState->id, [10]))
                                                                <td style="color:white;background-color:red"">{{ $orders[$i]->orderState->id."-".$orders[$i]->orderState->description }}</td>
                                                            @else
                                                                <td>{{ $orders[$i]->orderState->id."-".$orders[$i]->orderState->description }}</td>
                                                            @endif    
                                                        @endif
                                                    <td>
                                                        <a href="{{ route('coordinations.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
