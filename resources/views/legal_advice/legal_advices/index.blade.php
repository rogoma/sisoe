            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('legal_advices.index') }}">Llamados</a>
                        </li>
                    </ul>
                </div>
            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $orders[$i]->dncpPacIdFormat() }}</td>
                                                        ...
                                                        @else
                                                            ...
                                                            @endif
                                                        @endif                                                       
                                                        @if (in_array($orders[$i]->orderState->id, [96,99,102,105,142,145]))                                                                                                                    
                                                        ...
                                                        @endif
                                                    <td>
                                                        <a href="{{ route('legal_advices.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
