            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Agregar Tipo de Nivel Financiero</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Agregar Tipo de Nivel Financiero</h5>
                                </div>
                                <div class="card-block">
                                    <form method="POST" action="{{ route('financial_levels.store') }}">
                                        @csrf

                                        <div class="form-group row @error('number') has-danger @enderror">
                                            <label class="col-sm-2 col-form-label">Número</label>
                                            <div class="col-sm-10">
                                                <input type="text" id="number" name="number" value="{{ old('number') }}" class="form-control @error('number') form-control-danger @enderror" value="{{ old('number') }}">
                                                @error('number')
