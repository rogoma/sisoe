        ...
        <nav class="pcoded-navbar">
            <div class="nav-list">
                <div class="pcoded-inner-navbar main-menu">
                    ...
                    <div class="pcoded-navigation-label">Módulo de Pedidos y Llamados</div>
                    <ul class="pcoded-item pcoded-left-item">
                        <li class="pcoded-hasmenu">
                            <a href="javascript:void(0)" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="fa fa-list"></i></span>
                            <span class="pcoded-mtext">Pedidos/Llamados</span>
                            </a>
                            <ul class="pcoded-submenu">
                                <li class="@if(Route::currentRouteName() == 'coordinations.index') active @endif">
                                    <a href="{{ route('coordinations.index') }}" class="waves-effect waves-dark">
