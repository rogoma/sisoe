                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('permissions.update', $permission->id) }}">
                                        ...
                                        <div class="form-group row @error('description') has-danger @enderror">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="description" name="description" value="{{ old('description', $permission->description) }}" class="form-control @error('description') form-control-danger @enderror" value="{{ old('description', $permission->description) }}">
                                                @error('description')
