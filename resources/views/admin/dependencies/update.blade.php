                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('dependencies.update', $dependency->id) }}">
                                        ...
                                        <div class="form-group row @error('description') has-danger @enderror">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="description" name="description" value="{{ old('description', $dependency->description) }}" class="form-control @error('description') form-control-danger @enderror" value="{{ old('description', $dependency->description) }}">
                                                @error('description')
                                            ...
                                            <div class="col-sm-10">
                                                <select id="uoc_types" name="uoc_types" class="form-control">
                                                    ...
                                                    @foreach ($uoc_types as $uoc_type)
                                                        <option value="{{ $uoc_type->id }}" @if ($uoc_type->id == old('uoc_types',$dependency->uoc_type_id)) selected @endif>{{ $uoc_type->description }}</option>
                                                    @endforeach
                                                </select>
                                                @error('uoc_types')
                                                    <div class="col-form-label">{{ $message }}</div>
                                        ...
                                        <div class="form-group row @error('uoc_number') has-danger @enderror">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="uoc_number" name="uoc_number" value="{{ old('uoc_number', $dependency->uoc_number) }}" class="form-control @error('uoc_number') form-control-danger @enderror" value="{{ old('uoc_number') }}">                                                
                                                @error('uoc_number')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select id="superior_dependency" name="superior_dependency" class="form-control">
                                                    ...
                                                    @foreach ($dependencies as $superior_dependency)
                                                        <option value="{{ $superior_dependency->id }}" @if ($superior_dependency->id == old('superior_dependency',$dependency->superior_dependency_id)) selected @endif>{{ $superior_dependency->description }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row @error('sicp') has-danger @enderror">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="sicp" name="sicp" value="{{ old('sicp', $dependency->sicp) }}" class="form-control @error('sicp') form-control-danger @enderror" value="{{ old('sicp') }}">                                                                                                
                                                @error('sicp')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
