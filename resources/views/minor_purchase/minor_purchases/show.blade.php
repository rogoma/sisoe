                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        {{-- @if (in_array($order->actual_state, [20,45])) --}}
                                            ...
                                            {{-- SI NO ES PROCESO COVID RECIBE PBC DE UTA     --}}
                                            @if ($order->covid==0)
                                                {{-- PBC SIN REPARO DE PARTE DE UTA --}}
                                                @if ($order->actual_state == 96)
                                                    ...
                                                    <a style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" class="dropdown-item waves-effect f-w-600" href="javascript::void(0);" onclick="recibePBCdeUTA({{ $order->id }});">Recibir PBC de UTA-S/REPARO</a>
                                                @endif
                                                ...
                                                @if ($order->actual_state == 136)
                                                    <a style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" class="dropdown-item waves-effect f-w-600" href="javascript::void(0);" onclick="deriveUTA({{ $order->id }});">Derivar Informe de Evaluación a UTA</a>
                                                @endif

                                                {{-- EVALUACIÓN SIN REPARO DE PARTE DE UTA --}}
                                                @if ($order->actual_state == 99)
                                                    {{-- <button class="btn btn-danger dropdown-toggle waves-effect" type="button" id="acciones" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Recibir Proceso</button> --}}
                                    ...
                                    <div class="tab-content card-block">
                                        ...
                                        <div class="tab-pane" id="tab2" role="tabpanel">
                                            ...
                                            @if($order->providers->count() == 0)
                                                @if (Auth::user()->hasPermission(['minor_purchases.budget_request_providers.create']))
                                                    <a href="{{ route('orders.budget_request_providers.create', $order->id) }}" class="btn btn-primary">Agregar</a>
                                                @endif
                                            @else
                                                @if (Auth::user()->hasPermission(['minor_purchases.budget_request_providers.update']))
                                        ...
                                        <div class="tab-pane" id="tab5" role="tabpanel">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endfor
                                                    @for ($i=0; $i < count($related_simese_minor_purchase); $i++)
                                                    <tr>
                                                        <td>{{ $i+1 }}</td>
                                                        {{-- <td>{{ $related_simese_minor_purchase[$i]->year }}</td> --}}
                                                        <td>{{ number_format($related_simese_purchase[$i]->simese,'0', ',','.') }}-{{ $related_simese_purchase[$i]->year }}</td>
                                                        <td>{{ $related_simese_minor_purchase[$i]->dependency->description }}</td>
                                                    </tr>
                                                    @endfor
                                                </tbody>
                                            </table>
                                            <div class="text-right">
                                                ...
                                                @if(count($related_simese_minor_purchase) == 0)
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $other_files[$i]->dependency->description }}</td>
                                                        <td>{{ $other_files[$i]->updated_at }}</td>
                                                        <td>
                                                            ...
                                                            <button title="Eliminar Archivo" onclick="deleteFile({{ $minor_purchase_files[$i]->id }})" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endfor --}}
                                                </tbody>
                                        ...
                                        <div class="tab-pane" id="tab8" role="tabpanel">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                @for ($i=0; $i < count($queries); $i++)
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap">
                                                            <a href="{{ route('minor_purchases.queries.edit', [$order->id, $queries[$i]->id]) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Modificar</a>
                                                        ...
                                                        <div id="queryResponses{{ $queries[$i]->id }}" class="panel-collapse in collapse" role="tabpanel">
                                                            ...
                                                            <table class="table m-b-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="{{ route('minor_purchases.queries_responses.edit', [$queries[$i]->id, $query_response->id]) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Modificar</a></td>
                                                            ...
                                                            <div class="m-t-10 m-b-20">
                                                                <a href="{{ route('minor_purchases.queries_responses.create', $queries[$i]->id) }}" class="btn btn-sm btn-primary">Cargar Respuesta</a>
                                                            </div>
                                                        </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="text-right m-t-20">
                                                <a href="{{ route('minor_purchases.queries.create', $order->id) }}" class="btn btn-primary">Cargar Consulta</a>
                                            </div>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $i+1 }}</td>
                                                        <td>{{ $minor_purchase_filedncp_con[$i]->description }}</td>
                                                        {{-- <td>{{ $minor_purchase_filesdncp[$i]->file_type }}</td>                                                         --}}
                                                        <td>
                                        ...
                                        <div class="tab-pane" id="tab9" role="tabpanel">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="white-space: nowrap">
                                                            <a href="{{ route('minor_purchases.objections.edit', [$order->id, $objections[$i]->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Modificar</a>
                                            ...
                                            <div id="objectionResponses{{ $objections[$i]->id }}" class="panel-collapse in collapse" role="tabpanel">
                                                ...
                                                <table class="table m-b-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('minor_purchases.objections_responses.edit', [$objections[$i]->id, $obj_response->id]) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Modificar</a></td>
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $i+1 }}</td>
                                                        <td>{{ $minor_purchase_filedncp[$i]->description }}</td>
                                                        {{-- <td>{{ $minor_purchase_filesdncp[$i]->file_type }}</td>                                                         --}}
                                                        <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button title="Eliminar Archivo" onclick="deleteFile({{ $minor_purchase_files2[$i]->id }})" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endfor
                                                </tbody>
...
$(document).ready(function(){
    ...
    recibeOrder = function(order_id){
        $.ajax({
            url : '/minor_purchases/recibe_order/'+order_id,
            method: 'POST',
    ...
    deriveOrder = function(order_id){
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/derive_order/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    derivePAC = function(order_id){
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/derivePAC/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    deriveComite = function(order_id){
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/derive_comite/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    deriveUTA = function(order_id){
        swal({
            title: "Atención",
            text: "Derivar Evaluación a UTA?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#55dd6b",
            confirmButtonText: "Sí, derivar",
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/derive_uta/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    deriveAJ_PCovid = function(order_id){
        swal({
            title: "Atención",
            text: "Derivar Antecedentes (PROCESO COVID) a Asesoría Jurídica?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#55dd6b",
            confirmButtonText: "Sí, derivar",
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/deriveAJ_PCovid/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    deriveAJ_NoCovid = function(order_id){
        swal({
            title: "Atención",
            text: "Derivar Antecedentes a Asesoría Jurídica?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#55dd6b",
            confirmButtonText: "Sí, derivar",
        ...
        if(isConfirm){
        $.ajax({
            url : '/minor_purchases/deriveAJ_NoCovid/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    recibeOrderUTA = function(order_id){
        $.ajax({
            url : '/minor_purchases/recibe_order_uta/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    recibePBCdeUTA = function(order_id){
        $.ajax({
            url : '/minor_purchases/recibe_pbc_uta/'+order_id,
            method: 'POST',
            data: '_token='+'{{ csrf_token() }}',
            success: function(data){
                try{
    ...
    recibeOrderReparo = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/minor_purchases/recibeOrderReparo/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
    ...
    deleteQuery = function(query){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
              url : '/minor_purchases/{{ $order->id }}/queries/'+query,
              method : 'POST',
              data: {_method: 'DELETE', _token: '{{ csrf_token() }}'},
              success: function(data){
                try{
    ...
    deleteQueryResponse = function(query, query_response){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
              url : '/minor_purchases/'+query+'/queries_responses/'+query_response,
              method : 'POST',
              data: {_method: 'DELETE', _token: '{{ csrf_token() }}'},
              success: function(data){
                try{
    ...
    deleteObjection = function(objection){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
              url : '/minor_purchases/{{ $order->id }}/objections/'+objection,
              method : 'POST',
              data: {_method: 'DELETE', _token: '{{ csrf_token() }}'},
              success: function(data){
                try{
    ...
    deleteObjectionResponse = function(objection, objection_response){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
              url : '/minor_purchases/'+objection+'/objections_responses/'+objection_response,
              method : 'POST',
              data: {_method: 'DELETE', _token: '{{ csrf_token() }}'},
              success: function(data){
                try{
    ...
    updateQueriesDeadline = function(order_id){
        ...
        $.ajax({
            url : '/minor_purchases/update_queries_deadline/'+order_id,
            method: 'POST',
