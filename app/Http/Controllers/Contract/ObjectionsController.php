...
class ObjectionsController extends Controller
{
    ...
    public function create(Request $request, $order_id)
    {
        ...
        return view('contract.objections.create', compact('order'));
    }
    ...
    public function store(Request $request, $order_id)
    {
        ...
        return redirect()->route('contracts.show', $order_id)->with('success', 'Reparo agregado correctamente');
    }
    ...
    public function edit(Request $request, $order_id, $objection_id)
    {
        ...
        return view('contract.objections.update', compact('objection'));
    }
    ...
    public function update(Request $request, $order_id, $objection_id)
    {
        ...
        return redirect()->route('contracts.show', $order_id)->with('success', 'Reparo modificado correctamente');
    }
