            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('utas.index') }}">Llamados</a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            @for ($i = 0; $i < count($orders); $i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $orders[$i]->beginDateFormatmY() }}</td>
                                                        @if (in_array($orders[$i]->orderState->id, [26,95,98,140,141]))
                                                        ...
                                                        @endif
                                                    <td>
                                                        <a href="{{ route('utas.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
