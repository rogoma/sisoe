                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                                @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->modality_id, [9,10]) && in_array($order->actual_state, [20]))
                                                    ...
                                                    <a class="dropdown-item waves-effect f-w-600" style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" href="javascript::void(0);" onclick="recibeOrderCVE({{ $order->id }});">Recibir Pedido para Dictamen de CVE</a>
                                                @else
                                                    @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [96,102]))
                                                        <button class="btn btn-danger dropdown-toggle waves-effect" type="button" id="acciones" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Recibir</button>
                                                        <a class="dropdown-item waves-effect f-w-600" style="font-size: 14px; font-weight; color:blue;background-color:lightblue;" href="javascript::void(0);" onclick="recibeOrder({{ $order->id }});">Recibir PBC para Dictamen</a>
                                                    @else
                                                        @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [99]))
                                                            <button class="btn btn-danger dropdown-toggle waves-effect" type="button" id="acciones" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Recibir</button>
                                                            <a class="dropdown-item waves-effect f-w-600" style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" href="javascript::void(0);" onclick="recibeOrderEVAL({{ $order->id }});">Recibir Evaluación de Ofertas para Dictamen</a>
                                                        @else
                                                ...
                                                @if ($order->covid==0)
                                                    @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [142]))
                                                        {{-- <button class="btn btn-danger dropdown-toggle waves-effect" type="button" id="acciones" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Recibir</button>                                                     --}}
                                                        <a class="dropdown-item waves-effect f-w-600" style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" href="javascript::void(0);" onclick="recibeOrderEVAL({{ $order->id }});">Recibir Evaluación de Ofertas para Dictamen</a>
                                                    @endif
                                                @endif
                                                ...
                                                {{-- *** PARA DERIVAR DICTAMEN **** --}}
                                                @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [105]))
                                                    <a style="font-size: 14px; font-weight: bold; color:white;background-color:blue;" class="dropdown-item waves-effect f-w-600" href="javascript::void(0);" onclick="deriveDictamen({{ $order->id }});">Derivar Dictamen Adjunto de PBC a Dir./Coord. DOC</a>
                                                @endif

                                                {{-- *** PARA DERIVAR DICTAMEN de CVE**** --}}
                                                @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [107]))
                                                    <a style="font-size: 14px; font-weight: bold; color:white;background-color:blue;" class="dropdown-item waves-effect f-w-600" href="javascript::void(0);" onclick="deriveDictamenCVE({{ $order->id }});">Derivar Dictamen de Proceso CVE</a>
                                                @endif

                                                {{-- *** PARA DERIVAR DICTAMEN SOBRE EVALUACIÓN DE COMITE **** --}}
                                                @if (Auth::user()->hasPermission(['legal_advices.orders.derive']) && in_array($order->actual_state, [145]))
                                                    <a class="dropdown-item waves-effect f-w-600" style="font-size: 14px; font-weight: bold; color:blue;background-color:lightblue;" href="javascript::void(0);" onclick="deriveDictamenEVAL({{ $order->id }});">Derivar Dictamen de Evaluación de Ofertas</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <ul class="nav nav-tabs md-tabs" role="tablist">
                                        ...
                                        {{-- @if ($order->actual_state >=30) --}}
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tab8" role="tab"><i class="fa fa-files-o"></i> Dictamenes</a>
                                                <div class="slide"></div>
                                            </li>
                                        {{-- @endif --}}
                                    </ul>
                                    <div class="tab-content card-block">
                                        ...
                                        <div class="tab-pane" id="tab5" role="tabpanel">
                                            ...
                                            <div class="text-right">
                                                ...
                                                @if(count($related_simese_user) == 0 && Auth::user()->hasPermission(['admin.simese.create', 'orders.simese.create', 'legal_advices.simese.create']))
                                                <a href="{{ route('orders.simese.create', $order->id) }}" class="btn btn-primary">Cargar N° SIMESE</a>
                                                @elseif(Auth::user()->hasPermission(['admin.simese.update', 'orders.simese.update', 'legal_advices.simese.update']))
                                        ...
                                        <div class="tab-pane" id="tab6" role="tabpanel">
                                            ...
                                            {{-- <div class="text-right">
                                                @if (Auth::user()->hasPermission(['admin.files.create', 'orders.files.create', 'legal_advices.files.create','utas.files.create']))
                                                    <a href="{{ route('orders.files.create', $order->id) }}" class="btn btn-primary">Cargar Archivos</a>
                                                        @if ((Auth::user()->dependency->id == 56))
                                                           <div class="col-sm-10 text-left">
                                                           <h5>Adjuntar: Formulario de Verificación y otros archivos necesarios</h5>
                                                           </div>
                                                        @endif
                                        ...
                                        <div class="tab-pane" id="tab8" role="tabpanel">
                                            ...
                                            <div class="text-right">
                                                ...
                                                {{-- @if ((Auth::user()->dependency->id == 57)) --}}
                                                    <div class="col-sm-10 text-left">
                                                        <h5 style="font-size: 17px; font-weight: bold; color:red">Adjuntar: Dictamen de Pliego de Bases y Condiciones (PBC)</h5>
                                                    </div>
                                                @else
                                                    <div class="col-sm-10 text-left">
                                                        <h5 style="font-size: 17px; font-weight: bold; color:red">Adjuntar: Dictamen de Evaluación de Ofertas</h5>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
    ...
    recibeOrder = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/recibeOrder/'+order_id,
                method: 'POST',
    ...
    recibeOrderCVE = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/recibeOrderCVE/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
    ...
    deriveDictamen = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/deriveDictamen/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
    ...
    deriveDictamenCVE = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/deriveDictamenCVE/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
    ...
    recibeOrderEVAL = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/recibeOrderEVAL/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
    ...
    deriveDictamenEVAL = function(order_id){
      swal({
        ...
        function(isConfirm){
          if(isConfirm){
            $.ajax({
                url : '/legal_advices/deriveDictamenEVAL/'+order_id,
                method: 'POST',
                data: '_token='+'{{ csrf_token() }}',
                success: function(data){
                    try{
