                                ...
                                <div class="card-block">
                                    <form method="POST" action="{{ route('files.store') }}">
                                        ...
                                        <div class="form-group row @error('file_type_id') has-danger @enderror">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="file_type_id" name="file_type_id" value="{{ old('file_type_id') }}" class="form-control @error('file_type_id') form-control-danger @enderror" value="{{ old('file_type_id') }}">
                                                @error('file_type_id')
                                                    <div class="col-form-label">{{ $message }}</div>
                                                @enderror
                                            </div>
