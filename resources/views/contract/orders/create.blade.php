                                    ...
                                    <form method="POST" action="{{ route('contracts.orders.store', $contract->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="district" name="district_id" class="form-control @error('district_id') is-invalid @enderror">
...
$(document).ready(function(){
    ...
    $('#department').on('change', function() {
                ...
                $('#district').empty().append('<option value="">--- Seleccionar Distrito ---</option>');
