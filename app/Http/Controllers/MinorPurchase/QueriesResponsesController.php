...
class QueriesResponsesController extends Controller
{
    ...
    public function create(Request $request, $query_id)
    {
        ...
        return view('minor_purchase.queries_responses.create', compact('query'));
    }
    ...
    public function store(Request $request, $query_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $query->order_id)->with('success', 'Respuesta a consulta agregada correctamente');
    }
    ...
    public function edit(Request $request, $query_id, $query_response_id)
    {
        ...
        return view('minor_purchase.queries_responses.update', compact('query', 'query_response'));
    }
    ...
    public function update(Request $request, $query_id, $query_response_id)
    {
        ...
        return redirect()->route('minor_purchases.show', $query->order_id)->with('success', 'Respuesta a consulta modificada correctamente');
    }
