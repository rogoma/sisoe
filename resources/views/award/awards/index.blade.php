                                            ...
                                            @for ($i = 0; $i < count($orders); $i++)
                                                <tr>
                                                    ...
                                                    <td>{{ $orders[$i]->dncpPacIdFormat() }}</td>
                                                        ...
                                                        <td>{{ $orders[$i]->adjudicaDateFormat() }}</td>                                                        

                                                        @if (in_array($orders[$i]->orderState->id, [63,64,65,80,85,165]))
                                                        ...
                                                        @endif
                                                    <td>
                                                        <a href="{{ route('awards.show', $orders[$i]->id) }}" class="btn btn-primary">Ver Más</a>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
