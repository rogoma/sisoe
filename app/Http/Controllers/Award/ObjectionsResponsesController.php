...
class ObjectionsResponsesController extends Controller
{
    ...
    public function create(Request $request, $objection_id)
    {
        ...
        return view('tender.objections_responses.create', compact('objection'));
    }
    ...
    public function store(Request $request, $objection_id)
    {
        ...
        return redirect()->route('tenders.show', $objection->order_id)->with('success', 'Respuesta a reparo agregada correctamente');
    }
    ...
    public function edit(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return view('tender.objections_responses.update', compact('objection', 'objection_response'));
    }
    ...
    public function update(Request $request, $objection_id, $objection_response_id)
    {
        ...
        return redirect()->route('tenders.show', $objection->order_id)->with('success', 'Respuesta a reparo modificada correctamente');
    }
