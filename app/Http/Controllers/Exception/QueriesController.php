...
class QueriesController extends Controller
{
    ...
    public function create(Request $request, $order_id)
    {
        ...
        return view('exception.queries.create', compact('order'));
    }
    ...
    public function store(Request $request, $order_id)
    {
        ...
        return redirect()->route('exceptions.show', $order_id)->with('success', 'Consulta agregada correctamente');
    }
    ...
    public function edit(Request $request, $order_id, $query_id)
    {
        ...
        return view('exception.queries.update', compact('query'));
    }
    ...
    public function update(Request $request, $order_id, $query_id)
    {
        ...
        return redirect()->route('exceptions.show', $order_id)->with('success', 'Consulta modificada correctamente');
    }
